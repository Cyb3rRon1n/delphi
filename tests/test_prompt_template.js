...
assert.equal(
  looksLikeQuestion(
    "1.\nIn what stage of the client-trainer relationship are health-history " +
      "and lifestyle questionnaires administered?\na. Rapport Stage\nb. Investigative Stage\n" +
      "c. Planning Stage\nd. Action Stage"
  ),
  true
); // regression: a leading question-number label ("1.") must not be mistaken for a
   // preceding answer-key choice — real-world numbered-question format from tests.com
